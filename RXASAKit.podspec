...
Pod::Spec.new do |s|
  s.name             = 'RXASAKit'
  s.version          = '1.0.4'
  s.summary          = 'ruixue RXASAKit framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXASAKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXASAKit.git', :tag => s.version.to_s }
  ...
  s.frameworks = 'AppTrackingTransparency', 'AdServices', 'AdSupport', 'iAd'
